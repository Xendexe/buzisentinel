...
module.exports.run = async (bot, message, args) => {
  ...
  .addField("Használat", ",removerole [@user] [rang]", true)
  .addField("Példa", ",removerole @SteX Mod")
  ...
  if(!role) return message.channel.send(":thinking: ``Használat: ,removerole(@user) (rang) <-- (@ nélkül)``");
