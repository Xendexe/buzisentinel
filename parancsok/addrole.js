...
module.exports.run = async (bot, message, args) => {
  ...
  .addField("Használat", ",addrole [@user] [rang]", true)
  .addField("Példa", ",addrole @SteX Mod")
  ...
  if(!role) return message.channel.send(":thinking: ``Használat: ,addrole (@user) (rang) <-- (@ nélkül)``");
