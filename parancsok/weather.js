...
module.exports.run = async (bot, message, args) => {
    ...
    weather.find({search: args.join(" "), degreeType: "C"}, function(err, result) {
        ...
        if(result.length === 0) {
            message.channel.send("**Kérlek adj meg egy létező települést**")
            return;
        }
        ...
        let embed = new Discord.RichEmbed()
           ...
           .setAuthor(`Az időjárás a következő helyen --> ${current.observationpoint}`) //Shows the current location of the weater
